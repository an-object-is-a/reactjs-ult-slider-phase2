        ...
        return (
            <Fragment>
                ...
                <div style={styles.nav_buttons_container} ref={ref_id => this.nav_buttons_container = ref_id} className="nav_buttons_container">
                    <img style={styles.nav_buttons} ref={ref_id => this.nav_button_prev = ref_id} src="./prev.png" alt="prev" className="nav_buttons" id="prev" onClick={this.handle_prev} />
                    <img style={styles.nav_buttons} ref={ref_id => this.nav_button_next = ref_id} src="./next.png" alt="next" className="nav_buttons" id="next" onClick={this.handle_next} />
                </div>
